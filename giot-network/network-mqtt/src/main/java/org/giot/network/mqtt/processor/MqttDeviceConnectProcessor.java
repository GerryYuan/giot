...
public class MqttDeviceConnectProcessor extends AbstractSourceProcessor<DeviceStatus> implements MqttProcessor<DeviceStatus> {

    public MqttDeviceConnectProcessor(final ContainerManager containerManager) {
