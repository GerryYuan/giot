 ...
 */
public class HttpProcessorAdapter implements ProcessorAdapter {
    ...
    public HttpProcessorAdapter(final ContainerManager containerManager, final URLMappings urlMappings) {
