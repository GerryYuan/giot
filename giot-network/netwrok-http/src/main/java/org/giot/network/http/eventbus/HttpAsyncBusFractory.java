 ...
 */
public class HttpAsyncBusFractory implements BusFractory {

    private ExecutorService executorService;

    public HttpAsyncBusFractory(final int nThreads) {
    ...
    public Bus openBus() {
        if (bus == null) {
            this.bus = new GuavaAsyncBus(new AsyncEventBus(HttpContainer.NAME, executorService));
        }
        return this.bus;
    }
}
