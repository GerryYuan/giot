...
public class HttpDevicePropertiesReportProcessor extends AbstractSourceProcessor<DevicePropertiesMsg> implements HttpProcessor<DevicePropertiesMsg> {

    public HttpDevicePropertiesReportProcessor(final ContainerManager containerManager) {
